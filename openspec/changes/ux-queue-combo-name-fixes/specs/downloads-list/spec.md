...
The downloads grid SHALL let the user read a download's complete file name by hovering the pointer over its
Name cell, even when the name is too long to fit the column and is trimmed with an ellipsis.
