...
Every ComboBox in the application SHALL render its selected text and dropdown items with consistent inner
padding so the text sits inside the control rather than flush against its edge.
