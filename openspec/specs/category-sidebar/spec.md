## Purpose
An optional left sidebar that lists download categories (All plus each user category with icon,
name and count), lets the user filter the downloads list by category, and manages categories
(add/edit/reorder) in place.
