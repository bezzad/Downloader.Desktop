## Purpose
Lets the user export their app settings and category list to a portable file, and import one back
— e.g. to carry a setup between machines — without touching downloads, queues or schedules.
