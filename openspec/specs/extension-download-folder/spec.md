# extension-download-folder Specification

## Purpose

The extension's own download folder: prefilled from the app's configured default, editable as plain text, and applied to every hand-off so the app never asks where a file goes.
## Requirements
