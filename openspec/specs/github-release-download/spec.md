# github-release-download Specification

## Purpose

What a GitHub link means to the app: which links the GitHub plugin claims, which release a link
resolves to, and how that release's assets are offered to the user.
