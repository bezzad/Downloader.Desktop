# R&D: Downloading Instagram (and other site) videos

**Status:** research / plan only (no code yet — author to pick a direction).
...
1. Ship this at all, given the ToS/legal angle? (yes / no / yes-but-generic-framing)
2. If yes: full **option A (yt-dlp, multi-site)** — recommended — or just an experimental IG scraper?
3. Bundle binaries in the installer, or **download on first use** (recommended)?
