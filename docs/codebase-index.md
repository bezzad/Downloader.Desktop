...
| `Downloader.Desktop.Plugins.Ollama` | `com.bezzad.ollama-models` | `gemma3:12b` / ollama.com links → model blob download + an "Add to Ollama" install that writes the manifest LAST so Ollama never sees a half-install. |
